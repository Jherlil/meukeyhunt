...
uint64_t stride_u64 = 1;
	...
	printf("[+] Version %s, developed by AlbertoBSD\n",version);
        MLEngine::ml_load_model("models/best_model.pt");
    ...
    RLAgent::init();  // ✅ Inicializa RL agent
    ia::init("models/best_model.pt", "models/positive_hits_features.csv", "models/negative_hits_features.csv");
...
case 'r': {
    ...
    // Stride opcional
    stride_u64 = (tok.size() == 3) ? strtoull(tok[2].c_str(), nullptr, 0) : 1;
